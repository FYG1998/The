...
public class SoundUtils {
    ...
    public static void playSoundByMedia(int rawId) {
        try {
            ...
            try {
                AssetFileDescriptor file = APPAplication.getAppContext().getResources().openRawResourceFd(
                        rawId);
   ...
   static SoundPool soundPool;
    ...
    public static void playSound(int rawId) {
        ...
        final Context context=APPAplication.getAppContext();
        //第一个参数Context,第二个参数资源Id，第三个参数优先级
        soundPool.load(APPAplication.getAppContext(), rawId, 1);
